<%-- 
    Document   : subscribe
    Created on : 30 Jan, 2019, 5:36:14 PM
    Author     : Ketan
--%>
        ...
        <%
                try{
                    ...
                    Class.forName("com.mysql.jdbc.Driver");
                        ...
                        ResultSet rs2=st4.executeQuery("select * from subscribe where userid='"+id+"'and status=0");
                        %>
                        ...
                        while(rs2.next()){
                            ...
                            %>
                                ...
                                <td>                                     
                                <a href="delsub.jsp?id=<%=chan%>" class="glyphicon glyphicon-trash">Unsubscribe</a>				
                                </td>					                               													
				<div class="clearfix"> </div>
                                </tr>                                                             
                        <%
