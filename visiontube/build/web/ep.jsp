<%-- 
    Document   : ep.jsp
    Created on : 22 Jan, 2019, 5:43:37 PM
...
<div class="card" style="background-color: whitesmoke">
    ...
    <form action="epro.jsp?code=<%=code%>" method="post">
        <h3></h3>
        ...
        <input type="password" class="form-control" placeholder="Repeat Password" name="rp" required=""><br>
