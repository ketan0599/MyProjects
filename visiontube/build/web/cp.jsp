<%-- 
    Document   : cp
    Created on : 22 Jan, 2019, 3:54:39 PM
										...
										<h3>Create Channel</h3> 
                                                                                    ...
                                                                                    <div>
                                                                                        ...
                                                                                        <div class="form-control-static">
                                                                                            <form action="create.jsp?code=<%=code%>" method="post">
				...
				<div class="drop-navigation drop-navigation">
				  ...
				  <!-- script-for-menu -->
					...
					<div class="side-bottom">
						...
						<div class="copyright">
							<p>Copyright © 2019 My visiontube. All Rights Reserved | Design by <a href="main.jsp/">Ketan</a></p>
						</div>
					</div>
				</div>
        </div>
...
<div class="card" style="background-color: whitesmoke">
    ...
    <form action="cpass.jsp?code=<%=code%>" method="post">
        ...
        <h3>Repeated Password</h3>
        <input type="password" class="form-control" placeholder="Repeated Password" name="rp" required=""><br>
