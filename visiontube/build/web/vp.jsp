				...
				<div class="drop-navigation drop-navigation">
				  ...
				  <!-- script-for-menu -->
					...
					<div class="side-bottom">
						...
						<div class="copyright">
							<p>Copyright © 2019 My visiontube. All Rights Reserved | Design by <a href="index.jsp/">Karanveer</a></p>
						</div>
					</div>
				</div>
        </div>
...
<div class="card" style="background-color: white">
    ...
    <img src="profile/<%=icode%>.jpg"alt="<%=fname%>" style="width:100%">
  <h1><%=fname%> <%=lname%></h1>
  <p class="title"><%=mob%></p>
  <p>Channels : <%=cno%></p>
  <p>Uploads &nbsp; : <%=ul%></p>
  <p></p>
  <form action="ep.jsp?code=<%=code%>" method="post">
