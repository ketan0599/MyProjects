<%-- 
    Document   : blockusersearch
    Created on : 18 Feb, 2019, 5:58:21 PM
    Author     : Ketan
--%>
...
<%
       String email=null;
        ...
        if(email==null && session.getAttribute(email)==null){
            ...
            String sql="select * from user where status=5 and (fname LIKE '%"+search+"%' or lname LIKE '%"+search+"%' or mobile LIKE '%"+search+"%' or email LIKE '%"+search+"%'";            
