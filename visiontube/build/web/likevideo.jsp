<%-- 
    Document   : likevideo
    Created on : 1 Feb, 2019, 5:59:56 PM
    Author     : Ketan
--%>
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					...
					<li><a href="channel.jsp" class="user-icon"><span class="glyphicon glyphicon-music" aria-hidden="true"></span>Gallery</a></li>					
                                        ...
                                        <li class="active"><a href="likevideo.jsp" class="user-icon"><span class="glyphicon glyphicon-heart-empty" aria-hidden="true"></span>Liked Videos</a></li>
						...
						<h3>Liked Videos</h3>
                                        ...
                                        String img=null;
                                            ...
                                            String vid=null;
                                              try{
                                                ...
                                                ResultSet rs2=st2.executeQuery("select * from likes where userid='"+id+"'and status=0");
                                                while(rs2.next()){
                                                    vid=rs2.getString("vid");
                                                    try{
                                                        Class.forName("com.mysql.jdbc.Driver");
                                                                Connection cn2=DriverManager.getConnection("jdbc:mysql://localhost:3306/visiontube","root","");
                                                                Statement st3=cn2.createStatement();
                                                                ResultSet rs3=st3.executeQuery("select * from video where vid='"+vid+"'");
                                                                if(rs3.next()){
                                                                    img=rs3.getString(1);
                                    ...
                                    <div class="col-md-3 resent-grid recommended-grid slider-first">
                                                    ...
                                                    <div class="resent-grid-info recommended-grid-info">
                                                        <h3><a href="vidshow.jsp?id=<%=img%>" class="title title-info"><%=rs3.getString(2)%></a></h3>                                                                                                                               
                                                    </div> 
                                    </div>
                                                <%}
                                                                    cn2.close();
