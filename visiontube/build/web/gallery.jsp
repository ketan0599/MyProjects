<%-- 
    Document   : gallery
    Created on : 23 Jan, 2019, 5:03:10 PM
			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					...
					<li class="active"><a href="channel.jsp" class="user-icon"><span class="glyphicon glyphicon-music" aria-hidden="true"></span>Gallery</a></li>					
				...
				<div class="top-grids">
                     ...
                     try{
                         Class.forName("com.mysql.jdbc.Driver");
                                ...
                                ResultSet rs1=st1.executeQuery("select * from channel where cid ='"+cid+"'");
                                if(rs1.next()){
                                    cname1=rs1.getString(2);
                                }
                                cn1.close();
                     }
                     catch(Exception e){}%>
						...
						<h3><%=cname1%></h3>
                                    ...
                                    <%
                                        String img=null;
                                            ...
                                            try{
                                                ...
                                                ResultSet rs2=st2.executeQuery("select * from video where userid='"+id+"'and cid='"+cid+"'and (status=1 or status=2)");
                                                while(rs2.next()){
                                                    img=rs2.getString(1);
                                                    status=rs2.getString(8);
                                                    imge=img+".jpg";
                                    %>
                                    <div class="col-md-3 resent-grid recommended-grid slider-first">
                                                    ...
                                                    <div class="resent-grid-info recommended-grid-info">
                                                        ...
                                                        <%if(status.equals("1")){%>  
                                                        <a href="editvideo.jsp?code=<%=img%>" class="glyphicon glyphicon-edit" style="color:black"></a>             
                                                        <a href="deletevideo.jsp?code=<%=img%>" class="glyphicon glyphicon-trash" style="color:black"></a>
                                                           <%
                                                        }
                                                        else{   }%>
                                                    </div> 
