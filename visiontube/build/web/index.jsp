<%-- 
    Document   : index
    Created on : Jan 14, 2019, 10:52:33 AM
    Author     : Ketan
--%>
                                            ...
                                            %>
                                                <div class="col-md-4 resent-grid recommended-grid slider-first">
                                                    <div class="resent-grid-img recommended-grid-img">
                                                        <a href="indexvideo.jsp?id=<%=img%>"> <%out.println("<img src='video/images/"+imge+"' alt='"+imge+"' width='305px' height='225px'/>");%></a>
                                                    </div>
                                                    <div class="resent-grid-info recommended-grid-info">
                                                        <h3><a href="indexvideo.jsp?id=<%=img%>" class="title title-info"><%=rs2.getString(2)%></a></h3>
                                                    </div> 
                                                    						</div>
                                                <%}
                                                cn1.close();
