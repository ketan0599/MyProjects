				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					...
					<li><a href="channel.jsp" class="user-icon"><span class="glyphicon glyphicon-music" aria-hidden="true"></span>Gallery</a></li>					
                                        <li class="active"><a href="favourite.jsp" class="user-icon"><span class="glyphicon glyphicon-star-empty" aria-hidden="true"></span>favourites</a></li>
                                        ...
                                        String img=null;
                                            ...
                                            String vid=null;
                                              try{
                                                ...
                                                ResultSet rs2=st2.executeQuery("select * from favorites where userid='"+id+"'");
                                                while(rs2.next()){
