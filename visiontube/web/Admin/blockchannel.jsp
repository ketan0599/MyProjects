<%-- 
    Document   : blockchannel
    Created on : 7 Feb, 2019, 5:56:57 PM
    Author     : Ketan
--%>
        ...
        <%
            ...
            try{
                Class.forName("com.mysql.jdbc.Driver");
                        ...
                        PreparedStatement ps=cn1.prepareStatement("update channel set status=5 where cid='"+code+"'");
                        ps.execute();
                        PreparedStatement ps1=cn1.prepareStatement("update video set status=6 where cid='"+code+"'");
                        ps1.execute();
                        response.sendRedirect("channel.jsp?id=1");
                        cn1.close();                        
            }
            catch(Exception e){
                response.sendRedirect("channel.jsp?id=1");
