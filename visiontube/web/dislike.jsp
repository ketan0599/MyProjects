<%-- 
    Document   : dislike
    Created on : 28 Jan, 2019, 5:43:31 PM
    Author     : Ketan
--%>
        ...
        if(email==null && session.getAttribute(email)==null){
            ...
            try{
                                                        Class.forName("com.mysql.jdbc.Driver");
                                                            ...
                                                            ResultSet rs1=st1.executeQuery("select * from dislikes where userid='"+uid+"'and vid='"+vid+"'");
                                                            if(rs1.next()){
                                                                PreparedStatement ps=cn1.prepareStatement("delete from dislikes where userid='"+uid+"'and vid='"+vid+"'");
                                                                ps.execute();
                                                            }
                                                            else{
                                                                PreparedStatement ps=cn1.prepareStatement("delete from likes where userid='"+uid+"'and vid='"+vid+"'");
                                                                ps.execute();
                                                                PreparedStatement ps1=cn1.prepareStatement("insert into dislikes values(?,?)");
                                                                ps1.setString(1,uid);
                                                                ps1.setString(2,vid);
                                                                ps1.execute();
                                                            }
