<%-- 
    Document   : chshow
    Created on : 13 Feb, 2019, 10:35:33 AM
    Author     : Ketan
--%>
					...
					<div class="side-bottom">
						...
						<div class="copyright">
							<p>Copyright © 2019 My Visiontube. All Rights Reserved | Design by <a href="ketan.jsp/">Ketan</a></p>
                                            ...
                                            String img=null,imge=null,cname=null,csub=null;
                                            try{
                                                Class.forName("com.mysql.jdbc.Driver");
                                                Connection cn1=DriverManager.getConnection("jdbc:mysql://localhost:3306/visiontube","root","");
                                                Statement st4=cn1.createStatement();
                                                ResultSet rs4=st4.executeQuery("select * from channel where status=0 and cid='"+search+"'");
                                                if(rs4.next()){
                                                    cname=rs4.getString("cname");
                                                    csub=rs4.getString("csub");
                                                }%>
			...
			<div class="main-grids">
				<div class="top-grids">
					...
					<div class="container-fluid">
                                            <div class="col-sm-12">
                                            <div class="col-sm-2">
                                                <div><img src="profile/1.png" class="img-circle" style="width:100px;height:100px"></div>
                                            </div>
                                                <div class="col-sm-8">
						<h3><%=cname%></h3>
                                                <h5><%=csub%> Subscribers</h5>
                                                </div>
                                                <div class="col-sm-2">
                                                    <br><br>
                                        ...
                                        Statement st2=cn1.createStatement();
                                                ResultSet rs2=st2.executeQuery("select * from video where status=1 and cid='"+search+"'");
                                                while(rs2.next()){
                                                    img=rs2.getString(1);
                                                    imge=img+".jpg";
                                            %>
