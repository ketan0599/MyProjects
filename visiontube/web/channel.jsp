<%-- 
    Document   : vp
    Created on : Jan 17, 2019, 5:49:54 PM
				...
				<div class="drop-navigation drop-navigation">
					...
					<li ><a href="index.jsp" class="home-icon"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Home</a></li>
						...
						<ul class="cl-effect-2">
							...
							<li><a href="cp.jsp">Change Password</a></li> 
                                        ...
                                        <li><a href="channel.jsp" class="user-icon"><span class="glyphicon glyphicon-music glyphicon-blackboard" aria-hidden="true"></span>Gallery</a></li>
				  ...
				  <!-- script-for-menu -->
					...
					<div class="side-bottom">
						...
						<div class="copyright">
							<p>Copyright © 2019 My Spectertube. All Rights Reserved | Design by <a href="index.jsp">Ketan</a></p>
						</div>
					</div>
				</div>
        </div>
        ...
        <%
                try{
                    ...
                    Class.forName("com.mysql.jdbc.Driver");
                        ...
                        ResultSet rs2=st4.executeQuery("select * from channel where usercode='"+id+"'and status=0");
                        %>
                        ...
                        while(rs2.next()){
                            ...
                            %>
                                ...
                                <td>
                                    <h3><a href="gallery.jsp?code=<%=chan%>"><%out.println(rs2.getString("cname"));%></a></h3>
                                </td>
                                <td>
                                    <h3><%out.println(rs2.getString("date"));%></h3>
                                </td>
                                <td>                                   
                                <a href="bfeditchan.jsp?id=<%=chan%>" class="glyphicon glyphicon-edit"></a>																			                               
                                </td>
                                <td>                                     
                                <a href="delchan.jsp?id=<%=chan%>" class="glyphicon glyphicon-trash"></a>				
                                </td>					                               													
				<div class="clearfix"> </div>
                                </tr>                                                             
                        <%
