<%-- 
    Document   : sunblock
    Created on : 2 May, 2019, 6:52:38 PM
    Author     : Ketan
--%>
                                                                            ...
                                                                            <%
                                                                                try{
                                                                                     Class.forName("com.mysql.jdbc.Driver");
                                                                                        ...
                                                                                        ResultSet rs1=st1.executeQuery("select * from seller where status=1");
                                                                                        while(rs1.next()){
                                                                                            sn++;
                                                                                            %>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td><a href="unblockseller.jsp?id=<%=rs1.getString(9)%>"> Unblock</a></td>
                                                                                                </tr>
                                                                                            <%
                                                                                        }
                                                                                        cn.close();
