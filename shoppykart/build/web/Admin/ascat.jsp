<%-- 
    Document   : ascat
    Created on : 2 May, 2019, 4:02:11 PM
    Author     : Ketan
--%>
    ...
    <!-- left side start-->
		...
		<!-- //header-ends -->
			<div id="page-wrapper">
                            ...
                            <div class="col-sm-8">
                                <h2>Add SubCategories</h2><br><br>   
                                <form method="post" action="insertscat.jsp">
                                    ...
                                    <input type="text" name="scname" class="form-control" placeholder="Category name" required=""><br>
