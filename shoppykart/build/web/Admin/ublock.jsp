<%-- 
    Document   : ublock
    Created on : 2 May, 2019, 5:07:08 PM
    Author     : Ketan
--%>
                                                                            ...
                                                                            <%
                                                                                try{
                                                                                     Class.forName("com.mysql.jdbc.Driver");
                                                                                        ...
                                                                                        ResultSet rs1=st1.executeQuery("select * from user where status=0");
                                                                                        while(rs1.next()){
                                                                                            sn++;
                                                                                            %>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td><a href="blockuser.jsp?id=<%=rs1.getString(6)%>"><i class="fa fa-ban"></i> block</a></td>
                                                                                                </tr>
                                                                                            <%
                                                                                        }
                                                                                        cn.close();
