<%-- 
    Document   : varify
    Created on : 3 May, 2019, 4:05:33 PM
    Author     : Ketan
--%>
                                                                            ...
                                                                            <%
                                                                                try{
                                                                                     Class.forName("com.mysql.jdbc.Driver");
                                                                                        ...
                                                                                        ResultSet rs1=st1.executeQuery("select * from seller where status=2");
                                                                                        while(rs1.next()){
                                                                                            sn++;
                                                                                            %>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td><a href="verifyseller.jsp?id=<%=rs1.getString(9)%>"><span class="fa fa-check-circle"></span> Verify</a></td>
                                                                                                </tr>
                                                                                            <%
                                                                                        }
                                                                                        cn.close();
