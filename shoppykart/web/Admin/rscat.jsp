<%-- 
    Document   : rscat
    Created on : 2 May, 2019, 4:58:26 PM
    Author     : Ketan
--%>
                                                                            ...
                                                                            <%
                                                                                try{
                                                                                     Class.forName("com.mysql.jdbc.Driver");
                                                                                        ...
                                                                                        ResultSet rs1=st1.executeQuery("select * from subcategories where status=0");
                                                                                        while(rs1.next()){
                                                                                            sn++;
                                                                                            %>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td><a href="delscat.jsp?id=<%=rs1.getString(3)%>">Remove</a></td>
                                                                                                </tr>
                                                                                            <%
                                                                                        }
                                                                                        cn.close();
