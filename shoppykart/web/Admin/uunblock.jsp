<%-- 
    Document   : uunblock
    Created on : 2 May, 2019, 6:23:21 PM
    Author     : Ketan
--%>
                                                                            ...
                                                                            <%
                                                                                try{
                                                                                     Class.forName("com.mysql.jdbc.Driver");
                                                                                        ...
                                                                                        ResultSet rs1=st1.executeQuery("select * from user where status=1");
                                                                                        while(rs1.next()){
                                                                                            sn++;
                                                                                            %>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td><a href="unblockuser.jsp?id=<%=rs1.getString(6)%>"> Unblock</a></td>
                                                                                                </tr>
                                                                                            <%
                                                                                        }
                                                                                        cn.close();
