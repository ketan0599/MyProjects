<%-- 
    Document   : catsongs
    Created on : May 21, 2019, 3:16:17 PM
    Author     : Ketan
--%>
			...
			<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						  <ul class="nav navbar-nav">
							...
							<li class="hvr-bounce-to-bottom active"><a href="album.jsp">ALBUM</a></li>
						...
						<%
                                                    ...
                                                    try{
                                                        Class.forName("com.mysql.jdbc.Driver");
                                                            ...
                                                            ResultSet rs=st.executeQuery("select * from album where status=0 and catid='"+id+"'order by albumname");
                                                            while(rs.next()){
                                                %>		
                                                    <li>
                                                        <a href="albumsongs.jsp?id=<%=rs.getString("albumid")%>">
                                                        <img src="album/<%=rs.getString("albumid")%>.jpg" rel="title" style="width:350px;height:250px"/>
                                                        <div>
								<h5><%=rs.getString("albumname")%></h5>								
							</div>
                                                    </a>
                                                    </li>
                                                <%
