<%-- 
    Document   : uploadartistimg
    Created on : 18 May, 2019, 2:39:12 PM
...
<section id="main-content">
	<section class="wrapper">
             ...
             %>
                <div class="col-md-8">
                     <form method="post" ACTION="uploadartistimg1.jsp?code=<%=id%>" name="uploadForm" ENCTYPE='multipart/form-data'>
                        <table align="center" width="50%" height="25%">
                            <tbody>
                                <tr>
                                    <td><h2>Upload image of artist</h2></td>                                    
                                </tr><br>
                            <tr>
