<%-- 
    Document   : upload
    Created on : 17 May, 2019, 11:19:20 AM
...
<section id="main-content">
	<section class="wrapper">
                ...
                <div class="col-md-8">
                    ...
                    <form method="post" action="addsong.jsp?id=<%=id%>">
                        <br><h3>Title</h3>
                        ...
                        <h3>Description</h3>
                        <textarea name="Desc" placeholder="Description" class="form-control"></textarea><br><br>
                        <h3>Album Name</h3>
                        <%
                                    if(id==null){
                        %>
                        <select class="form-control" name="aname">
                            <%
                                Class.forName("com.mysql.jdbc.Driver");
                                    ...
                                    ResultSet rs1=st1.executeQuery("select * from album where status=0");
                                    while(rs1.next()){                                       
                            %>
                                        <option value="<%=rs1.getString("albumid")%>"><%=rs1.getString("albumname")%></option>
                            <%
                                    }
                                    cn1.close();
                            %>
                        ...
                        <%
                                         ...
                                         Class.forName("com.mysql.jdbc.Driver");
                                                Connection cn4=DriverManager.getConnection("jdbc:mysql://localhost:3306/music","root","");
                                                Statement st4=cn4.createStatement();
                                                ResultSet rs4=st4.executeQuery("select * from album where status=0 and albumid='"+id+"'");
                                                if(rs4.next()){
                                        %>
                                        <select class="form-control" name="aname">
                                            <option value="<%=id%>" selected="" ><%=rs4.getString("albumname")%></option>
                            <%
                                Class.forName("com.mysql.jdbc.Driver");
                                    Connection cn1=DriverManager.getConnection("jdbc:mysql://localhost:3306/music","root","");
                                    Statement st1=cn1.createStatement();
