<%-- 
    Document   : uploadsongimg
    Created on : 17 May, 2019, 11:46:56 AM
...
<section id="main-content">
	<section class="wrapper">
             ...
             %>
                <div class="col-md-8">
                     <form method="post" ACTION="uploadsongimg1.jsp?code=<%=id%>" name="uploadForm" ENCTYPE='multipart/form-data'>
                        <table align="center" width="50%" height="25%">
                            <tbody>
                                <tr>
                                    <td><h2>Upload image for music Cover</h2></td>                                    
                                </tr><br>
                            <tr>
