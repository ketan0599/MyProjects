<%-- 
    Document   : uploadsong
    Created on : 17 May, 2019, 11:52:11 AM
...
<section id="main-content">
	<section class="wrapper">
             ...
             %>
                <div class="col-md-8">
                     <form method="post" ACTION="uploadsong1.jsp?code=<%=code%>" name="uploadForm" ENCTYPE='multipart/form-data'>
                        <table align="center" width="50%" height="25%">
                            <tbody>
                                <tr>
                                    <th><h2>Upload music file</h2></th>                                    
                                </tr><br>
                            <tr>
