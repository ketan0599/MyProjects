<%-- 
    Document   : rmvcat
    Created on : 16 May, 2019, 11:11:34 PM
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                    <a class="active" href="rmvcat.jsp">
                            ...
                            <tbody>
                                ...
                                %>
                                            <tr data-expanded="true">                                
                                                ...
                                                <td><a class="btn btn-warning form-control" href="checkrmvcat.jsp?id=<%=rs.getString("cid")%>">Delete</a></td>                 
                                            </tr>
                                            <%
                                        }
                                            %>
