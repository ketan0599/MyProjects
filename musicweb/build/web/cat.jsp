<%-- 
    Document   : cat
    Created on : May 21, 2019, 3:04:44 PM
    Author     : Ketan
--%>
			...
			<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						  <ul class="nav navbar-nav">
							...
							<li class="hvr-bounce-to-bottom"><a href="album.jsp?id=1">ALBUM</a></li>
							<li class="hvr-bounce-to-bottom"><a href="songs.jsp">SONGS</a></li>
                                                        <li class="hvr-bounce-to-bottom"><a href="artist.jsp">ARTIST</a></li>
                                                        <li class="hvr-bounce-to-bottom active"><a href="cat.jsp">CATEGORY</a></li>
						...
						<%
                                                    try{
                                                        Class.forName("com.mysql.jdbc.Driver");
                                                            ...
                                                            ResultSet rs=st.executeQuery("select * from category order by cname");
                                                            while(rs.next()){
                                                %>		
                                                    <li>
                                                        <a href="catsongs.jsp?id=<%=rs.getString("cid")%>">
                                                        <img src="category/<%=rs.getString("cid")%>.jpg" rel="title" style="width:350px;height:250px"/>
                                                        <div>
								<h5><%=rs.getString("cname")%></h5>								
							</div>
                                                    </a>
                                                    </li>
                                                <%
