<%-- 
    Document   : user
    Created on : 16 May, 2019, 4:00:52 PM
...
<section id="main-content">
	<section class="wrapper">
                ...
                <div class="col-md-8">
                    <h2>Album Name</h2><br><br>
                    <form method="post" action="addalbum.jsp">
                        <input type="text" name="aname" placeholder="Album Name" class="form-control"><br><br>
