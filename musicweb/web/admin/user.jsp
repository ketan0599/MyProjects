<%-- 
    Document   : user
    Created on : 16 May, 2019, 5:16:26 PM
                            ...
                            <tbody>
                                <%
                                    Class.forName("com.mysql.jdbc.Driver");
                                        ...
                                        ResultSet rs=st.executeQuery("select * from user where status=0");
                                        while(rs.next()){                                           
                                %>
                                            <tr data-expanded="true">                                
                                                ...
                                                <td><a class="btn btn-warning" href="blockuser.jsp?id=<%=rs.getString("ucode")%>">Block</a></td>
                                            </tr>
                                            <%
                                        }
                                            %>
