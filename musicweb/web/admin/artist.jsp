<%-- 
    Document   : artist
    Created on : 18 May, 2019, 2:32:35 PM
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                    <a class="active" href="artist.jsp">
...
<section id="main-content">
	<section class="wrapper">
                ...
                <div class="col-md-8">
                    <h2> Add Artist</h2><br><br>
                    <form method="post" action="addartist.jsp">
                        <input type="text" name="artist" placeholder="Artist Name" required="" class="form-control">
                        <br><br>
