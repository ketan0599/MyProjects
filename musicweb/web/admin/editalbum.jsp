<%-- 
    Document   : editalbum
    Created on : 18 May, 2019, 2:07:29 PM
...
<%
            ...
            Class.forName("com.mysql.jdbc.Driver");
                ...
                ResultSet rs=st.executeQuery("select * from album where albumid='"+id+"'");
                if(rs.next()){
...
<section id="main-content">
	<section class="wrapper">
                ...
                <div class="col-md-8">
                    <h2>Album Name</h2>
                    <form method="post" action="updatealbum.jsp?id=<%=id%>">
                        <input type="text" name="aname" value="<%=name%>" placeholder="Album Name" class="form-control"><br><br>
