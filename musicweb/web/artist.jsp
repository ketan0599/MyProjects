<%-- 
    Document   : artis
    Created on : 18 May, 2019, 3:16:30 PM
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						  <ul class="nav navbar-nav">
							...
							<li class="hvr-bounce-to-bottom"><a href="songs.jsp">SONGS</a></li>
                                                        <li class="hvr-bounce-to-bottom active"><a href="artist.jsp">ARTIST</a></li>
						...
						<%
                                                    try{
                                                        Class.forName("com.mysql.jdbc.Driver");
                                                            ...
                                                            ResultSet rs=st.executeQuery("select * from artist order by artistname");
                                                            while(rs.next()){
                                                %>		
                                                    <li>
                                                        <a href="artistsongs.jsp?id=<%=rs.getString("artistid")%>">
                                                        <img src="artist/<%=rs.getString("artistid")%>.jpg" rel="title" style="width:350px;height:250px"/>
                                                        <div>
								<h5><%=rs.getString("artistname")%></h5>								
							</div>
                                                    </a>
                                                    </li>
                                                <%
